...
.mt-field{
  ...
  color: #181818;
  line-height: 1rem;
  font-size: 0.28rem;border-bottom: thin solid #e5e5e5;
  padding: 0 0.2rem;
}
  .mt-field label{
    width: 1.86rem;
  ...
  .mt-field input{width:3rem;}
  .maya-btn{
    width: 6.9rem;
    height: 0.8rem; text-align: center;border:none;background:#e0e0e0;}
